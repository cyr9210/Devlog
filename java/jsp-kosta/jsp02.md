...
date: '2019-01-02T18:25:16.000Z'
tags: JSP
---

# Cookie, Session,익스프레션, JSTL, 필터
...
![JSP](../../.gitbook/assets/jsp02-01.png)
...
![JSP](../../.gitbook/assets/jsp02-04.png)

* post방식 → servlet에 해당 내용을 추가한다.

  request.setCharacterEncoding\(“utf-8”\);

![JSP](../../.gitbook/assets/jsp02-05.png)
...
![JSP](../../.gitbook/assets/jsp02-06.png)
...
![JSP](../../.gitbook/assets/jsp02-07.png)

* driver 로딩 → connection연결 → Statement생성 → query문 작성 → query문 처리

**예제**

![JSP](../../.gitbook/assets/jsp02-08.png)
...
![JSP](../../.gitbook/assets/jsp02-09.png)

* 앞서 statement를 사용한 방식과 유사하나 쿼리문을 ‘?’를 활용하여 그 후 PreparedStatement를 생성한다.

**예제**

![JSP](../../.gitbook/assets/jsp02-10.png)

* 추 후 선언할 내용들에대해 ‘?’를 활용하여 sql문을 작성한다.
* prepareStatement를 생성하고, 그후 setString메소드를 통해 ‘?’에 들어갈 값을 설정한다.
* 역순으로 close\(\);

내가 해당예제를 풀며 생각한 주의사항은 ?를 입력할 시 ‘ ’를 생략하고 넣어야한다는 것이다. 나는 pstmt를 활용하여 sql문 작성 시, ‘?’ 로 작성하여 해결하기 위해 오랜시간을 소요했다. 또한 connection, Statement\(prepareStatement\), resultset을 반드시 close\(\)해야 한다는것을 주의하자.\(역순으로\)   
  


### DAO/DTO

![JSP](../../.gitbook/assets/jsp02-11.png)
...
![JSP](../../.gitbook/assets/jsp02-12.png)
...
* 제목/글쓴이/내용 작성한 내용을 form\_action3.jsp에 넘겨준다.
* form\_action3는 넘겨받은 내용을 useBean 액션태그를 사용해 bean객체를 생성하여 담는다.
...
![JSP](../../.gitbook/assets/jsp02-13.png) 상기 내용은 POOLED 타입으로 설정 된 mybatis-config.xml 이다. 해당내용을 JNDI타입으로 변경하면 아래와 같이 가능하다.

![JSP](../../.gitbook/assets/jsp02-14.png)

* url, username, password등 DB연결을 위한 정보들을 server/context.xml의 태그 안에 추가한다.
* 추가한 Resource의 name을 mybatis-config.xml에 맞추어 준다.

![JSP](../../.gitbook/assets/jsp02-15.png) 작성된 xml은 상기예시와 같이 사용된다.
...
> **tip** try\($\){내용} → $의 위치에 openSession해줄경우 자동으로 close된다.
...
![JSP](../../.gitbook/assets/jsp02-16.png) ![JSP](../../.gitbook/assets/jsp02-17.png)
...
![JSP](../../.gitbook/assets/jsp02-18.png) 상기예시와 같이 선언 및 매핑한 함수를 사용한다.
...
중복되는 query문을 include해서 사용 가능하다. ![JSP](../../.gitbook/assets/jsp02-19.png)

#### Result 매핑

DB컬럼과 객체필드의 name이 다를 때, resultMap을 사용하여 매핑할 수 있다.\(아래 예시는 DB의 컬럼과 객체필드의 name이 같으므로 올바른 예제는 아니다.\) ![JSP](../../.gitbook/assets/jsp02-20.png)

#### 동적 Query문 \(동적 SQL\)

![JSP](../../.gitbook/assets/jsp02-21.png) ![JSP](../../.gitbook/assets/jsp02-22.png)

* DB에 전달할 파라미터값을 두개이상 넣어야할때는 객체화를 시키거나 hashmap을 만들어서 전달해야한다.

![JSP](../../.gitbook/assets/jsp02-23.png)
...
![JSP](../../.gitbook/assets/jsp02-24.png)
