...
* 객체 생성 ![springcore](../../.gitbook/assets/springcore03-01.png)
* PropertyEditor를 implements 하는것은 오버라이딩할 메소드가 많다. PropertyEditorSupport를 상하여 필요에 맞도록 적용 ![springcore](../../.gitbook/assets/springcore03-02.png)
* 이벤트 컨트롤러 작성 ![springcore](../../.gitbook/assets/springcore03-03.png)
* 테스터 작성 매칭되는 에디터가 없어서 에러가 발생한다. ![springcore](../../.gitbook/assets/springcore03-04.png)
* 앞선 설명과 같이 빈으로 등록하지 않고 InitBinder사용하여 메소드 생성 및 테스트를 실행한다. Evnet 클래스를 EventEditor를 사용하여 데이터바인딩하겠다는 뜻 ![springcore](../../.gitbook/assets/springcore03-05.png)  

#### Converter와 Formatter

**Converter**

![springcore](../../.gitbook/assets/springcore03-06.png)

* S 타입을 T 타입으로 변환할 수 있는 매우 일반적인 변환기.
* 상태 정보 없음 = Stateless = 쓰레드세이프 \(→ bean으로 등록이 가능하다.\)
* ConverterRegistry에 등록해서 사용

  ![springcore](../../.gitbook/assets/springcore03-07.png)\(빈으롱 등록하지 않았을 때 사용방법이다.\)

* 기본적인 Integer 등의 타입은 기본적으로 지원해준다.

**Formatter**

![springcore](../../.gitbook/assets/springcore03-08.png)
...
* FormatterRegistry에 등록해서 사용
  ...
  ![springcore](../../.gitbook/assets/springcore03-09.png)\(빈으롱 등록하지 않았을 때 사용방법이다.\)

**ConversionService**

![springcore](../../.gitbook/assets/springcore03-10.png)
...
* Formatter와 Converter 빈을 찾아 자동으로 등록해 준다. ![springcore](../../.gitbook/assets/springcore03-11.png)
* 테스트방법
  * 계층형 테스트로 웹과 관련된 빈만 테스트로 등록해준다.   
    ...
    ![springcore](../../.gitbook/assets/springcore03-12.png)
* 등록되어있는 ConversionService

    ![springcore](../../.gitbook/assets/springcore03-13.png)
