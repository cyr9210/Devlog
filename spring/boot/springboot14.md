...
date: '2019-04-16T22:18:31.000Z'
tags: SpringBoot
---

# 스프링 부트 활용14 - 스프링 시큐리티
...
![springboot](../../.gitbook/assets/springboot14-1.png)
...
* 의존성을 추가하게 되면 정상작동하던 컨트롤러테스트가 실패하게 된다. ![springboot](../../.gitbook/assets/springboot14-2.png)
  * 401 Unauthorized
...
* 스프링 부트 시큐리티 자동 설정
  ...
  * SpringBootWebSecurityConfiguration
    ...
    * WebSecurityConfigurerAdapter의 내용을 그대로 쓰고있다.
      ...
      ![springboot](../../.gitbook/assets/springboot14-6.png)

      * WebSecurityConfigurerAdapter 핵심내용

        ![springboot](../../.gitbook/assets/springboot14-7.png)
  * WebSecurityConfigurerAdapter를 상속하는 Configuration클래스\(@Configuration 빈등록\)를 만들면 거의 동일하게 동작하는 나만의 시큐리티 설정을 가질 수 있다. ![springboot](../../.gitbook/assets/springboot14-9.png)
  * UserDetailsServiceAutoConfiguration ![springboot](../../.gitbook/assets/springboot14-8.png)
  ...
  * 사용자 설정
    ...
    * 기본 Password: 애플리케이션을 실행할 때 마다 랜덤 값 생성 \(콘솔에 출력 됨.\)
      ...
      ![springboot](../../.gitbook/assets/springboot14-4.png)
...
* test 방법
  ...
  * @WithMockUser 사용 ![springboot](../../.gitbook/assets/springboot14-10.png)
  * 설정한 유저로 테스트 ![springboot](../../.gitbook/assets/springboot14-11.png)
...
* 웹 시큐리티 설정
  ...
  * 결과
    * 루트
        ...
        ![springboot](../../.gitbook/assets/springboot14-13.png)

    * hello

        ![springboot](../../.gitbook/assets/springboot14-14.png)

    * my

        ![springboot](../../.gitbook/assets/springboot14-15.png)
* [UserDetailsServie 구현](https://docs.spring.io/spring-security/site/docs/current/reference/htmlsingle/#jc-authentication-userdetailsservice)
  ...
  * User관련 서비스를 생성한다. ![springboot](../../.gitbook/assets/springboot14-17.png)
  * implements UserDetailsService
    * @Override loadByUsername

      ![springboot](../../.gitbook/assets/springboot14-18.png)
      ...
      * User의 파라미터로 name, password를 넣고 세번째 인자로 authorities\(\)메서드를 생성해서 넣어준다.
          ...
          ![springboot](../../.gitbook/assets/springboot14-16.png)
...
* PasswordEncoder 설정 및 사용
  * 인코딩을 안하고 로그인을 하면.. 오류 발생
    ...
    ![springboot](../../.gitbook/assets/springboot14-19.png)

  * 패스워드를 직접 DB에 넣으면 안된다. **인코딩 필수**
  * Security 설정했던 클래스에서 패스워드 인코더를 아무것도 인코딩하지 않는 NoOpPasswordEncoder를 리턴하는 PasswordEncoder를 빈으로 등록하면 로그인이 가능하다. **그러나, 절대로 이런 방법을 사용하면 안된다. 패스워드 인코더를 사용해야한다.** ![springboot](../../.gitbook/assets/springboot14-20.png)
  * 스프링 시큐리티 권장 패스워드 인코더 사용
    * 패스워드 인코더 빈 등록
      ...
      ![springboot](../../.gitbook/assets/springboot14-21.png)

    * 패스워드 인코딩 ![springboot](../../.gitbook/assets/springboot14-22.png)
    * 인코딩 결과 ![springboot](../../.gitbook/assets/springboot14-23.png)
